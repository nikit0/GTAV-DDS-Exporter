...
def config_ini(overwrite):
    ...
    # Define the path to the GTAV-DDS-Exporter.ini file
    ini_file_path = os.path.join(script_dir, "GTAV-DDS-Exporter.ini")            
    ...
    if os.path.exists(ini_file_path):
        ...
        if 'General' in config and 'TexConvDirectory' in config['General']:
            ...
            print("GTA V DDS Exporter Plugin: TexConvDirectory value set or updated in GTAV-DDS-Exporter.ini")
...
def convert_png_to_dds(texconvPath, sourcePNG, overwrite):
    ...
    if filename.endswith(".png"):
        ...
        if suffix in ["Diffuse", "Normal", "Specular", "Emissive"]:
...
class GTAVDDSPlugin:
    def __init__(self):
        ...
        self.window.setWindowTitle("GTA V DDS Auto Converter")
...
GTAV_DDS_PLUGIN = None

def start_plugin():
    """This method is called when the plugin is started."""
    print ("GTA V DDS Exporter Plugin Initialized")
    global GTAV_DDS_PLUGIN
    GTAV_DDS_PLUGIN = GTAVDDSPlugin()

def close_plugin():
    """This method is called when the plugin is stopped."""
    print ("GTA V DDS Exporter Plugin Shutdown")
    global GTAV_DDS_PLUGIN
    del GTAV_DDS_PLUGIN
